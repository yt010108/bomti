...
export function EvaluationResult({
  ...
  return (
    <section className="bomti-result bomti-stack" aria-labelledby="evaluation-result-heading">
      ...
      <ScoreMeter score={verdict.finalIndex} dimensions={Object.entries(verdict.dimensions).map(([key, score]) => ({ label: labels[key] ?? key, score, explanation: verdict.dimensionExplanations?.[key] }))} />
